...
export const PARAM_CONFIG: ParamConfigMap = {
  ...
  'SAR': { b1: 10, b2: 26, unit: '', name: 'Sodium Adsorption Ratio', keywords: ['sar', 'sodium adsorption ratio'] },
  'RSC': { b1: 1.25, b2: 2.5, unit: 'meq/L', name: 'Residual Sodium Carbonate', keywords: ['rsc', 'residual sodium carbonate'] },
};
