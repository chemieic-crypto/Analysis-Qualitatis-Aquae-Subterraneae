...
export default function DetailedView({
  ...
  const activeConfig = activeParam === "SAR"
    ? { b1: 10, b2: 26, unit: '', name: 'Sodium Adsorption Ratio (SAR)', keywords: ['sar'] }
    : activeParam === "RSC"
    ? { b1: 1.25, b2: 2.5, unit: 'meq/L', name: 'Residual Sodium Carbonate (RSC)', keywords: ['rsc'] }
    : PARAM_CONFIG[activeConfigKey];
  ...
  useEffect(() => {
    ...
    if (activeParam === "SAR") {
      ...
      if (activeParam === "RSC" || activeConfigKey === "RSC") {
