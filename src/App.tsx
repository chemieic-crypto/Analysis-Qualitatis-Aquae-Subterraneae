...
export default function App() {
  ...
  const filteredData = useMemo(() => {
    ...
    return filtered;
  }, [rawData, selectedState, selectedDistrict, headers.state, headers.district]);
  ...
  const yearFilteredData = useMemo(() => {
    ...
    return filtered;
  }, [rawData, selectedState, selectedDistrict, selectedYear, headers.state, headers.district, headers.year]);
  ...
  const yearSeasonFilteredData = useMemo(() => {
    ...
    return filtered;
  }, [yearFilteredData, selectedSeason, headers.season]);
